...
- `boll-break-buy` / `BOLL下轨买入，上轨卖出`: when not holding, intraday low below the BOLL(60, 2) lower band and close below MA60 signals buy; when holding, a non-limit-up close plus intraday high above the BOLL(60, 2) upper band and close above MA60 signals sell, or a non-limit-up close plus holding more than 180 trading days signals sell.
